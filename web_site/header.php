    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse align-items-center" id="navbarCollapse">
            ...
            <div class="d-flex align-items-center">
                <a class="btn btn-sm-square mx-1" href="https://www.facebook.com/CEFI.COSTARICA?mibextid=ZbWKwL" target="_blank" title="Síguenos en Facebook">
                    <i class="fab fa-facebook-f"></i>
                </a>
                <a class="btn btn-sm-square mx-1" href="https://www.instagram.com/cefi_cr?igsh=ZnNrZDRhdTB6Z3I0" target="_blank" title="Estamos en Instagram">
                    <i class="fab fa-instagram"></i>
                </a>
                <a class="btn btn-sm-square mx-1" href="https://youtube.com/@ceficr?si=Prh18hZuQhWG6hdY" target="_blank" title="Estamos en Youtube">
                    <i class="fab fa-youtube"></i>
                </a>
                <a class="btn btn-sm-square mx-1" href="https://www.tiktok.com/@cefi_cr?_t=8jw1rg8zAJh&_r=1" target="_blank" title="Estamos en Tiktok">
