        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center py-5">
                    <h1 class="display-3 text-white animated slideInDown" style="margin-top: 100px;">Contacto</h1>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h5>Donde estamos</h5>
                    <p class="mb-4">Guápiles, 50mts norte de la bomba EUSSE, en el Centro Educativo Valle Del Sol.</p>
